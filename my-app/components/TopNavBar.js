...
export default function TopNavBar() {
  ...
  return (
    <Navbar
      className={`shadow-sm border-bottom ${theme === "light" ? "bg-white" : "bg-dark"}`}
      sticky="top"
      expand="md"
      style={{ zIndex: 1050 }}
    >
      <Container>
        <Navbar.Brand
          as={Link}
          href="/"
          className="d-flex align-items-center fw-bold fs-4 text-decoration-none text-body"
        >
          <img
            src="/emblem.jpg"
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-end">
          <Nav className="me-4 align-items-center gap-3">
            <Nav.Link as={Link} href="/vault" className="fw-semibold text-body">
              My Vault
            </Nav.Link>
            <Nav.Link
              as={Link}
            ...
            {isLoggedIn && (
              <div className="position-relative" ref={dropdownRef}>
                ...
                {showNotifs && (
                  <div
                    className="position-absolute end-0 mt-2 bg-body border rounded shadow-lg"
                    style={{
                      width: 340,
                      zIndex: 1060,
                      maxHeight: 420,
          ...
          <button
            onClick={toggleTheme}
            className={`btn btn-sm rounded-pill px-3 py-1 fw-bold shadow-sm d-flex align-items-center ${theme === "light" ? "btn-dark" : "btn-light"}`}
          >
